 ...
 * Spinner, EmptyState, ConfirmModal all in one file.
 * Import: import { Spinner, EmptyState, ConfirmModal } from '../components/ui'
 */
...
export default { Spinner, EmptyState, ConfirmModal }
